...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Pavlo-Petrashevskyi.github.io/react_movies-list/) and add it to the PR description.
