...
1. Extract a `.movies`f block to a `MoviesList` component.
...
- Replace `matvii1` with your Github username in the [DEMO LINK](https://matvii1.github.io/react_movies-list/) and add it to the PR description.
