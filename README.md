...
1. Create and export a `Movie` interface inside `./src/types/Movie.ts` (all the fields are required)  - done
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://batiukova-nataliia.github.io/react_movies-list/) and add it to the PR description.
