...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://stanislav-bzhezinskyi.github.io/react_movies-list/) and add it to the PR description.
